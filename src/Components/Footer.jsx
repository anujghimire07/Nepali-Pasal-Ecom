      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <p className="text-sm mb-6">
            Nepali Pasal is a factory brand produced by Shop Stylers, the makers
            of the world's highest quality knit fabrics and apparel.
          </p>
        ...
        <div>
          ...
          <div className="flex">
            <input
              ...
              className="w-full px-3 py-2 rounded-l-lg to-whitetext-black outline-none"
            />
